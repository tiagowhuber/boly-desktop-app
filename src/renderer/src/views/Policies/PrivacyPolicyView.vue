...
<template>
  <div class="privacy-policy-container">
    ...
    <p>
      Welcome to Boly! Your privacy is important to us. This Privacy Policy outlines how we collect,
    ...
    <li>Account information (e.g., username, date of birth)</li>
    ...
    <li>Send important updates, promotions, or relevant notifications</li>
    <li>Ensure the security and integrity of our platform</li>

    <h2>3. Sharing Your Information</h2>
    <p>
      We do not sell your personal information. However, we may share your information with trusted
      third parties to:
    </p>
    ...
    <li>
      Receive information about our data practices and how they relate to your personal information
    </li>
    <li>Exercise your data protection rights</li>
    ...
    <p>
      We may update this Privacy Policy from time to time. Changes will be communicated through our
      platform or via email. Continued use of our services after changes indicates your acceptance
    ...
    <!-- <h2>9. Contact Us</h2>
        <p>
            ...
            <a href="mailto:W5u0f@example.com">W5u0f@example.com</a>.
        </p> -->
    <p style="margin-top: 2em">Thank you for trusting Boly. Your privacy is our priority.</p>
  </div>
</template>

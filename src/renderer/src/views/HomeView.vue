...
import QuickAccessPanel from '@/desktop-components/QuickAccessPanel.vue'
...
/** The quick-access panel reports its own successes and failures through here. */
...
<template>
  ...
  <QuickAccessPanel @notify="notify" />
